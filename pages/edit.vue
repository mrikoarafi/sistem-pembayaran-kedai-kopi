...
<template>
  <div class="min-h-screen bg-gradient-to-br from-amber-50 to-orange-50">
      ...
      <div class="container mx-auto px-6 py-4">
        <div class="flex justify-between items-center">
          ...
          <div class="flex items-center gap-4">
            <NuxtLink to="/transaksi" class="bg-blue-600 text-white px-4 py-2 rounded-full hover:bg-blue-700 transition-colors text-sm font-medium">
              Lihat Pembayaran
    ...
    <div class="container mx-auto px-6 py-8">
      <!-- Form Section -->
      <div class="bg-white rounded-2xl shadow-xl p-8 mb-8 border border-amber-100">
      ...
      <div class="bg-white rounded-2xl shadow-xl p-8 border border-amber-100">
        ...
        <div v-else-if="error" class="bg-red-50 border border-red-200 text-red-700 px-6 py-4 rounded-xl mb-4 text-center">
          ...
          <button @click="loadProduk" class="mt-3 text-red-600 underline hover:text-red-800">
            Coba lagi
          </button>
        </div>
            ...
            <div class="relative h-48 overflow-hidden">
              ...
              <div class="absolute top-3 left-3">
                <span :class=" [
                  ...
                  getCategoryStyle(produk.kategori)
                ]">
              ...
              <div class="absolute top-3 right-3">
                <span :class=" [
                  'px-3 py-1 rounded-full text-xs font-semibold shadow-lg',
                  produk.stok > 10 ? 'bg-green-500 text-white' : 
                  produk.stok > 0 ? 'bg-yellow-500 text-white' : 
      ...
      <div class="bg-white rounded-2xl p-8 max-w-md w-full mx-4 shadow-2xl">
        <div class="text-center">
          ...
          <p class="text-gray-600 mb-6">
            ...
            <span class="font-semibold">"{{ deleteTarget?.nama }}"</span>? 
